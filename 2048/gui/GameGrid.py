...
class GameGrid(tk.Frame):
    ...
    def init_grid(self):
        background = tk.Frame(self, bg=c.BACKGROUND_COLOR_GAME,
        ...
        for i in range(c.GRID_LEN):
            ...
            for j in range(c.GRID_LEN):
                cell = tk.Frame(background, bg=c.BACKGROUND_COLOR_CELL_EMPTY,
                ...
                t = tk.Label(master=cell, text="",
                          ...
                          justify=tk.CENTER, font=c.FONT, width=5, height=2)
                t.grid()
                grid_row.append(t)
